  ...
  .set( function (val, path) {
    ...
    if (val instanceof Document) {
      if (typeof val.id !== "undefined") {
        ...
        return new DBRef(val._schema._collection, val._.doc._id); //{'$ref': val._schema._collection, '$id': val._.doc._id};
      } else {
...
type('dbrefArray')
  ...
  .set( function (val, path) {
    ...
    return val.map( function (el, idx) {
      return new DBRef(el._schema._collection, el._.doc._id); //{'$ref': el._schema._collection, '$id': el._.doc._id};
    });
  })
  .get( function (val, path) {
...
DBReffedArray.prototype._fetch = function (fn) {
  ...
  conditions[this.parentReferredAs] = new DBRef(this.parent._schema._collection, this.parent._.doc._id); //;{'$ref': this.parent._schema._collection, '$id': this.parent._.doc._id};
...
type('dbreffedArray')
  .setup( function (key, path) {
    ...
    this.post('save', function (referringMember) {
